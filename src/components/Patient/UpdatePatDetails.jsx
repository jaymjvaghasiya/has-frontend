...
export const UpdatePatDetails = () => {
    ...
    const { register, handleSubmit, formState: { errors } } = useForm({
        defaultValues: async () => {
            ...
            let add = res.data.data.address.split(', ');
            return {
                ...
                address: add[add.length - 2],
                area: add[add.length - 1],
                country: res.data.data.country,
                state: res.data.data.state,
                city: res.data.data.city,
                pincode: res.data.data.pincode,
                contactNum: res.data.data.contactNum,
                alternatievNo: res.data.data.alternatievNo,
                diseases: res.data.data.diseases,
                registrationType: res.data.data.registrationType,
                docType: res.data.data.docType,
                referredBy: res.data.data.referredBy
            }
        }
    });
    ...
    const submitHandler = async (data) => {
        try {
            ...
            console.log(newObj?.maritalStatus);

            const res = await axios.put('http://localhost:3001/patient/' + id, formData);
            console.log(res.data.data);
            if (res.status === 200) {
            ...
            <form action="" className="patientRegistration" onSubmit={handleSubmit(submitHandler)}>
                ...
                <div className="row">
                    ...
                    <div className="col">
                        ...
                        <div className="field">
                            <select name="bloodGroup" className='reqfield' id="bloodGroup" {...register('bloodGroup')}>
                    ...
                    <div className="col">
                        ...
                        <div className="field">
                            ...
                            {/* <select name="role" id="role" className='reqfield' {...register('role', validationSchema.role)}>
                ...
                <div className="remark">
                    <div className="field">
                        <input type="checkbox" checked name="remark" id="remark" {...register('remark')} />
                    </div>
                    <div className="fname">
